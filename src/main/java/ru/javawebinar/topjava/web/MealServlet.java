...
public class MealServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        Meal meal = new Meal(id.isEmpty() ? null : Integer.valueOf(id), LocalDateTime.parse(request.getParameter(
                "dateTime")), request.getParameter("description"), Integer.parseInt(request.getParameter("calories")));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        switch (action == null ? "all" : action) {
            ...
            case "filter":
                log.info("getByDates");
                request.setAttribute("meals", controller.getByDates(startDate, endDate, startTime, endTime));
